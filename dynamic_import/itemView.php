...
*/
  ...
  $spielplatzText = getSpielplatzInfo($ID); //$$$$$$$$
  if ($spielplatzText == "JA"){
		//echo "hat einen spielplatz";
		$spielplatzText="<img src='images/ico_spielplatz2.gif' title='Hat einen Kinderspielplatz.'>";
	} else {
    $spielplatzText = "";
  }
...
echo <<< EOT
                    ...
                    <tr>
						<td width="100%" valign="middle" bgcolor="#CCCC99" height="107"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
							<img src="images/spacer.gif" width="10" height="10"><img src="images/ico_uhr.gif" title='Öffnungszeiten' width="15" height="15">$ico_nurbeischoenwetter$ico_hatwaszumdrinsitzen$spielplatzText&nbsp;$zeiten<br>
...
EOT;
  ...
  //------------------------------------------------------------
  // checkt ob ein Spielplatz eingetragen ist beim bauern
  //------------------------------------------------------------
  function getSpielplatzInfo ($bauern_ID){
	
  	$spielplatzResult=mysql_query("SELECT spielplatz FROM most_bauer WHERE ID=$bauern_ID") or die ("itemView.php;getSpielplatzInfo(): Database error (".mysql_error().")");
  	list($spielplatz)=mysql_fetch_row($spielplatzResult);
  	//echo("*******".$spielplatz."+++++++++");
  	if ($spielplatz == "") $spielplatz="NEIN";
